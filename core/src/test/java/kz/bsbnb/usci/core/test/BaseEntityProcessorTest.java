...
public class BaseEntityProcessorTest {
    ...
    public void processBaseEntityTest() throws SQLException {
        ...
        BaseEntity currency = eavBaseFactory.createBaseEntity("ref_currency", reportDate, 0L, batchId);
        ...
        BaseEntity creditPurpose = eavBaseFactory.createBaseEntity("ref_credit_purpose", reportDate, 0L, batchId);
        currency.put("code", new BaseValue("01"));
        credit.put("credit_purpose", new BaseValue(creditPurpose));

        BaseEntity creditObject = eavBaseFactory.createBaseEntity("ref_credit_object", reportDate, 0L, batchId);
        ...
        BaseEntity financeSource = eavBaseFactory.createBaseEntity("ref_finance_source", reportDate, 0L, batchId);
        ...
        //---- залоги
        BaseSet pledges = eavBaseFactory.createBaseSet("pledge");

        BaseEntity pledgeType10 = eavBaseFactory.createBaseEntity("ref_pledge_type", reportDate, 0L, batchId);
        pledgeType10.put("code", new BaseValue("10"));

        BaseEntity pledgeType18 = eavBaseFactory.createBaseEntity("ref_pledge_type", reportDate, 0L, batchId);
        pledgeType18.put("code", new BaseValue("18"));

        BaseEntity pledge0 = eavBaseFactory.createBaseEntity("pledge", reportDate, respondentId, batchId);
        ...
        BaseEntity pledge1 = eavBaseFactory.createBaseEntity("pledge", reportDate, respondentId, batchId);
    ...
    public void creditChangeTurnoverTest() throws SQLException {
        Long respondentId = 2384L;
        Long batchId = 17L;
        LocalDate reportDate = LocalDate.of(2018, 12, 1);
        ...
        //change
        BaseEntity change = eavBaseFactory.createBaseEntity("change", reportDate, respondentId, batchId);
        BaseEntity turnover = eavBaseFactory.createBaseEntity("turnover", reportDate, respondentId, batchId);
        BaseEntity issue = eavBaseFactory.createBaseEntity("turnover_issue", reportDate, respondentId, batchId);

        BaseEntity debt = eavBaseFactory.createBaseEntity("turnover_issue_debt", reportDate, respondentId, batchId);
